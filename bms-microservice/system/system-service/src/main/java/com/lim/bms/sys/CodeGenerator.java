...
public class CodeGenerator {
    ...
    /** 项目路径 */
    private final static String projectPath = "C:\\Users\\Lim\\Workspaces\\GitHub\\bms\\bms-microservice\\system";
    /** 包基础路径 */
    private final static String packagePath = "com.lim.bms.sys";
    /** 父类-数据库通用字段 */
    private final static String entityParent = "com.lim.bms.commons.database.BaseEntity";
    /** 写于父类的字段 */
